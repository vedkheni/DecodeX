...
<div class="container-fluid">
    ...
    <div class="row bg-title">
        ...
        <div class="col-sm-4 text-right">
            ...
            <h4 class="page-title text-center">Deposit Reports</h4> 
...
if(isset($search['month']) && isset($search['year'])){
		...
		if(!empty($prof_tax_count)){
			if($m == $current_month && $y == $current_year){
				foreach($prof_tax_count as $prof_tax_total){
					$sum+=($prof_tax_total->salary * $prof_tax_total->salary_deduction)/100;
				}
			}else{
				foreach($prof_tax_count as $prof_tax_total){
					$sum+=$prof_tax_total->deposit_amount;
				}
			}		
		}
    ...
    <div class="row">
		<div class="col-md-12">
			...
			<form class="form-horizontal form-material frm-search" method="post" action="<?php echo base_url('reports/deposit'); ?>" id="bonus-form">
