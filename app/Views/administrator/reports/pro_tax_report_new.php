   ...
   <div class="container-fluid">
      <div class="row bg-title">
         ...
         <div class="col-lg-12 col-md-12 col-xs-12">
            <h4 class="page-title">Prof Tax Reports</h4>
         </div>
         <!-- <div class="col-sm-4">
            <ol class="breadcrumb">
               <li><a href="#">Reports</a></li>
               <li class="active">Prof Tax Reports</li>
            </ol>
         </div> -->
      </div>
      <div class="row">
         <div class="col-md-12">
                  ...
                  <div class="row">
                     <div class="col-12 text-center">
                       <div class="single-field select-field multi-field _search-form">
                         <select id="bonus_year" onchange="get_prof_tax(1,'Y');" name="bonus_year" >
                     ...
                     <a href="<?php echo base_url("export_excel/prof_tax_excel/1"); ?>" class="btn btn-primary pull-left export_excel " name="export_excel">Export Excel</a>
                     </div>
            ...
            <div class="deposit-table">
               ...
               <table  class="display nowrap deposit-list-table" >
                  <tbody class="deposit-details prof_tax_detail">
