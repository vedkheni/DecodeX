   ...
   <div class="container-fluid">
      <div class="row bg-title">
         ...
         <div class="col-lg-12 col-md-12 col-xs-12">
            <h4 class="page-title">Bonus Reports</h4>
         </div>
         <!-- <div class="col-sm-4">
            <ol class="breadcrumb">
               <li><a href="#">Reports</a></li>
               <li class="active">Bonus Reports</li>
            </ol>
         </div> -->
      </div>
      <div class="row">
               ...
               <form class="frm-search" method="post" action="">
                  <div class="row">
                     <div class="col-12 text-center">
                        ...
                        <a href="<?php echo base_url("export_excel/bouns_excel/1"); ?>" class="btn btn-primary pull-left export_excel " name="export_excel">Export Excel</a>
                     </div>
