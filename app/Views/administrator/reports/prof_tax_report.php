...
<div class="container-fluid">
    ...
    <div class="row bg-title">
        ...
        <div class="col-sm-4 text-right">
            ...
            <h4 class="page-title text-center">Professional Tax Reports</h4> 
        ...
        <div class="col-sm-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Professional Tax Reports</li>
		...
		if(!empty($prof_tax_count)){
			if($m == $current_month && $y ==  $current_year){
				foreach($prof_tax_count as $prof_tax_total){
					$sum+=$this->allfunction->prof_tax($prof_tax_total->salary);
				}
			}else{
				foreach($prof_tax_count as $prof_tax_total){
					$sum+=$prof_tax_total->prof_tax;
				}
			}
		}
    ...
    <div class="row">
		<div class="col-md-12">
			...
			<form class="form-horizontal form-material frm-search" method="post" action="<?php echo base_url('reports/prof_tax'); ?>" id="bonus-form">
			<div class="_form-search-form">
				...
				<div class="col-lg-4 col-md-6 _search-form">
					<div class="col-md-12 emp_">
						...
						<div class="emp_submit">
							<input type="button"  class="btn btn-primary pull-left emp_search " id="salary_month_search" name="salary_month_search"  value="Search">
                ...
                <div class="table-responsive box-shadow">
					<div class="total-sum"><strong>Total : <span><?php echo $sum; ?></span></strong></div>
