			    		...
			    		<div class="row">
			    					...
			    					<div class="single-field select-field">
			    						<select name="employee_select" id="employee_select">
			    							...
			    							<?php foreach($employee_list as $emp){ ?>
			    								<option  data-percentage="<?php echo $emp->salary_deduction ?>" data-salary="<?php echo $emp->salary ?>"  value="<?php echo $emp->id; ?>"><?php echo $emp->fname ." ".$emp->lname; ?></option>
			    							<?php } ?>
			    						</select>
			    			...
			    			<div class="col-6 form_submit">
								<div class="emp_ float-right">
									<div class="emp_submit">
										<input type="submit" class="btn btn-primary emp_search" value="Submit">
									</div>
								</div>
							</div>
