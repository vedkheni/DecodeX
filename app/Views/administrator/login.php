...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/login/css/style.css?56g4dfgs">
	<style>
    .massge_for_error.text-center {
        color: red;
    }
	</style>
    <script src="<?php echo base_url(); ?>assets/login/js/fontawesome-89e70b322a.js" crossorigin="anonymous"></script>
...
<div class="login-wrap">
    ...
    <div class="login-right">
            <div class="login-form">
                <form class="sign-in-form validate-form" method="POST" id="employee-login_form" action="<?php echo base_url('admin'); ?>">
                    ...
                    <div class="massge_for_error text-center"><?php // echo $this->session->getFlashdata('messages'); ?> </div> -->
                    <input type="hidden" name="<?=csrf_token();?>" value="<?=csrf_hash();?>" />
                    <h2 class="title"><span>Welcome Back Admin!</span>Sign into your Account</h2>
    ...
    <script src="<?php echo base_url(); ?>assets/login/vendor/jquery/jquery-3.5.1.slim.min.js"></script>
